  ...
  return (
    <div className="w-full bg-backk">
      <div className="flex flex-col  py-4 mx-auto ">
        <div className="h-full  flex flex-row  px-5 gap-1 items-start">
          <Link href="/" className=" ">
        ...
        <h1 className="text-[#FFF]  font-Poppins text-[16px] normal font-[500] leading-normal py-3 px-7">
        ...
        <div className="flex flex-row px-5 flex-wrap">
          <input
            ...
            className="bg-[#0C0263]	 rounded-l-[5px] backdrop-blur-[5px] px-5 py-3 items-center w-[400px] placeholder:text-[#FFF] placeholder:text-center placeholder:font-Poppins placeholder:text-[16px] normal font-[500] leading-normal"
          />
